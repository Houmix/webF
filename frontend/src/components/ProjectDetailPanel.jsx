    ...
    >
      ...
      <div style={{ display: "flex", gap: 8 }}>
        <input
          ...
          min="0"
          required
          value={flux.electricity}
          onChange={(e) => setFlux({ ...flux, electricity: e.target.value })}
          placeholder="Électricité (kW)"
          style={{
            borderRadius: 8,
        ...
        <input
          ...
          required
          value={flux.water}
          onChange={(e) => setFlux({ ...flux, water: e.target.value })}
          placeholder="Eau (L)"
          style={{
            borderRadius: 8,
            border: "1px solid #b3d4fc",
        ...
        <input
          ...
          required
          value={flux.internet}
          onChange={(e) => setFlux({ ...flux, internet: e.target.value })}
          placeholder="Internet (Mbps)"
          style={{
            borderRadius: 8,
            border: "1px solid #b3d4fc",
            padding: 8,
